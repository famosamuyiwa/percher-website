        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              <a href="#search" className="text-black-200 hover:text-primary-300"
                >Search Perchs</a
              >
              <a href="#features" className="text-black-200 hover:text-primary-300"
                >Features</a
              >
              <a
                href="#how-it-works"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-black-100 mb-12 max-w-2xl mx-auto">
            Discover beautiful houses and properties for rent. Search, book, and
            manage your rental journey - all in one seamless platform.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 rounded-2xl bg-white shadow-lg">
            <div
              className="w-12 h-12 bg-accent-100 rounded-full flex items-center justify-center mb-4"
            >
              <span className="material-symbols-rounded" style={{ color: '#ff7f50' }}>
                travel_explore
              </span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 rounded-2xl bg-white shadow-lg">
            ...
            <p className="text-black-100">
              Comprehensive tools for perch owners and guests to explore, manage
              navigation and get insights on a particular region.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-white shadow-lg">
            <div
            ...
            <p className="text-black-100">
              Direct communication between guests and perch owners with instant
              notifications.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-white shadow-lg">
            ...
            <p className="text-black-100">
              Experience the perch without ever setting foot in it by exploring
              virtually from the comfort of your device.
            </p>
          </div>
        </div>
      </div>
    ...
    <section id="search" className="py-20 bg-secondary-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg max-w-3xl mx-auto">
          ...
          <button
            className="w-full bg-primary-300 text-white py-3 rounded-lg hover:bg-primary-300/90"
          >
            Search Properties
          </button>
        </div>
          ...
          <div>
            <div className="space-y-8">
              <div className="flex gap-4">
                <div
                  className="w-8 h-8 rounded-full bg-primary-300 flex items-center justify-center text-white font-bold"
                >
                  1
                </div>
                <div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-black-100">
                    Book perch viewings instantly with our real-time scheduling
                    system.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-black-100">
                    Submit your application and necessary documents all through
                    the app.
                  </p>
                </div>
              </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg">
            <div className="flex items-center mb-4">
              ...
              />
              <div className="ml-4">
                <h4 className="font-semibold text-secondary-300">Favour I.</h4>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg">
            <div className="flex items-center mb-4">
              ...
              />
              <div className="ml-4">
                <h4 className="font-semibold text-secondary-300">Famosa O.</h4>
                <p className="text-black-100">Gwarinpa, Abuja</p>
              </div>
            </div>
            <p className="text-black-200">
              "The filters helped me find exactly what I was looking for within
